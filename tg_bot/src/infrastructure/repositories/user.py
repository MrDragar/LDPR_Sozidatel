...
from src.domain.entities import EventApplication, Sources
...
class UserRepository(IUserRepository):
    ...
    async def create_user(self, user: EventApplication) -> EventApplication:
    ...
    async def get_user(self, user_id: int, source: Sources) -> EventApplication:
